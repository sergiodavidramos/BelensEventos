...
export class MobiliarioComponent implements OnInit {
  ...
  carrito(mobi: any){
    ...
    this.guardarStorage(mobi)

  }

  
  guardarStorage(mobi:any){
    // localStorage.setItem('id', id);
    // localStorage.setItem('usuario',JSON.stringify(usuario));

    // this.usuario= usuario;
    this._usuarioServices.servicios[this._usuarioServices.contador-1]=mobi;
    this._usuarioServices.total+=mobi.precio;
